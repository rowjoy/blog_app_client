class MyPostModel {
  ...
  MyPostModel.fromJson(Map<String, dynamic> json) {
    ...
    postOriginCountry = json['postOriginCountry'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['postOriginCountry'] = this.postOriginCountry;
...
class Author {
  ...
  Author({this.firstName, this.lastName, this.avatarUrl});
